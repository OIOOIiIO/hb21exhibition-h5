var page1_text = "<div id='cover-part1' class='fade-in-1'> <div class='cover-indent'><div id='tittle-bar-img' class='tittle-part1-left-indent'></div></div> <div id='tittle-text-img'><div id='tittle-text-img1' class='tittle-part1-left-indent'></div><div id='tittle-text-img2' class='tittle-part1-left-indent'></div></div> </div> <div id='cover-part2' class='fade-in-1'> <div id='tittle-img' class='cover-indent'></div> <div class='next-ico-unity next-ico-border cover-next'><div class='next-ico-arrow-unity next-ico-arrow cover-next'></div></div> <div id='enter-img' class='cover-next'></div> </div> <div id='cover-part3' class='fade-in-1'> <div id='tittle-label-img' class='cover-indent'></div> </div>"
var page2_text ="<div id='catalog' class='cover-indent'> <div id='catalog-right'> <div class='catalog-block catalog-block-left catalog-right' id='introduction-text'></div> <div class='catalog-block catalog-block-mid catalog-right' id='competition-situation'></div> <div class='catalog-block catalog-block-right catalog-right' id='award'></div> </div> <div id='catalog-left'> <div class='catalog-block catalog-block-left' id='first-prize'></div> <div class='catalog-block catalog-block-mid' id='second-prize'></div> <div class='catalog-block catalog-block-right' id='third-prize'></div> </div> </div> <div id='cover-part1' class='fade-in-1'> <div class='catalog-indent'><div id='catalog-text-img1' class='tittle-part1-left-indent'></div><div id='catalog-text-img2' class='tittle-part1-left-indent'></div></div> </div> <div id='cover-part2' class='fade-in-1'> <div class='back-to-cover-indent next-ico-unity next-ico-border-pre back-to-cover'> <div class='next-ico-arrow-unity next-ico-arrow-pre back-to-cover'></div> </div> <div id='tittle-img' class='catalog-indent'></div> </div> <div id='cover-part3' class='fade-in-1'> <div id='tittle-label-img' class='catalog-indent'></div> </div>"
...
var fade = function(){
    var fade_in = document.getElementsByClassName('fade-in-1')[0];
    if(fade_in)
    {
        document.getElementsByClassName('chart-text')[0].classList.add('fade-in-1');
        document.getElementsByClassName('chart-text')[0].addEventListener('animationend',function(){
            document.getElementsByClassName('chart-text')[0].classList.remove('fade-in-1');
        });
    }
}
page1_next();